...
Defined in: figmaPluginTypes.ts:8958
...
- [`DefaultShapeMixin`](DefaultShapeMixin.md).[`ConstraintMixin`](ConstraintMixin.md).[`StickableMixin`](StickableMixin.md).[`AspectRatioLockMixin`](AspectRatioLockMixin.md)
...
Defined in: figmaPluginTypes.ts:8966
...
Defined in: figmaPluginTypes.ts:8970
...
> **getAuthorAsync**(): `Promise`\<`null` \| [`BaseUser`](BaseUser.md)\>

Defined in: figmaPluginTypes.ts:8977
...
`Promise`\<`null` \| [`BaseUser`](BaseUser.md)\>
