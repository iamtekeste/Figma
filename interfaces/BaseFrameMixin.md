...
Defined in: figmaPluginTypes.ts:7106
...
- [`BaseNodeMixin`](BaseNodeMixin.md).[`SceneNodeMixin`](SceneNodeMixin.md).[`ChildrenMixin`](ChildrenMixin.md).[`ContainerMixin`](ContainerMixin.md).[`DeprecatedBackgroundMixin`](DeprecatedBackgroundMixin.md).[`GeometryMixin`](GeometryMixin.md).[`CornerMixin`](CornerMixin.md).[`RectangleCornerMixin`](RectangleCornerMixin.md).[`BlendMixin`](BlendMixin.md).[`ConstraintMixin`](ConstraintMixin.md).[`LayoutMixin`](LayoutMixin.md).[`ExportMixin`](ExportMixin.md).[`IndividualStrokesMixin`](IndividualStrokesMixin.md).[`AutoLayoutMixin`](AutoLayoutMixin.md).[`AspectRatioLockMixin`](AspectRatioLockMixin.md).[`AnnotationsMixin`](AnnotationsMixin.md).[`DevStatusMixin`](DevStatusMixin.md)
...
[`GeometryMixin`](GeometryMixin.md).[`dashPattern`](GeometryMixin.md#dashpattern)
...
[`GeometryMixin`](GeometryMixin.md).[`fillGeometry`](GeometryMixin.md#fillgeometry)
...
[`GeometryMixin`](GeometryMixin.md).[`fills`](GeometryMixin.md#fills)
...
[`GeometryMixin`](GeometryMixin.md).[`fillStyleId`](GeometryMixin.md#fillstyleid)
...
The id of the [GridStyle](GridStyle.md) object that the [BaseFrameMixin.layoutGrids](#layoutgrids) property of this node is linked to.
...
[`GeometryMixin`](GeometryMixin.md).[`strokeAlign`](GeometryMixin.md#strokealign)
...
[`GeometryMixin`](GeometryMixin.md).[`strokeCap`](GeometryMixin.md#strokecap)
...
[`GeometryMixin`](GeometryMixin.md).[`strokeGeometry`](GeometryMixin.md#strokegeometry)
...
[`GeometryMixin`](GeometryMixin.md).[`strokeJoin`](GeometryMixin.md#strokejoin)
...
[`GeometryMixin`](GeometryMixin.md).[`strokeMiterLimit`](GeometryMixin.md#strokemiterlimit)
...
[`GeometryMixin`](GeometryMixin.md).[`strokes`](GeometryMixin.md#strokes)
...
[`GeometryMixin`](GeometryMixin.md).[`strokeStyleId`](GeometryMixin.md#strokestyleid)
...
[`GeometryMixin`](GeometryMixin.md).[`strokeWeight`](GeometryMixin.md#strokeweight)
...
[`GeometryMixin`](GeometryMixin.md).[`outlineStroke`](GeometryMixin.md#outlinestroke)
...
[`GeometryMixin`](GeometryMixin.md).[`setFillStyleIdAsync`](GeometryMixin.md#setfillstyleidasync)
...
Set the [GridStyle](GridStyle.md) that the [BaseFrameMixin.layoutGrids](#layoutgrids) property of this node is linked to.
...
[`GeometryMixin`](GeometryMixin.md).[`setStrokeStyleIdAsync`](GeometryMixin.md#setstrokestyleidasync)
