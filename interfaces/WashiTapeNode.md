...
Defined in: figmaPluginTypes.ts:9109
...
- [`DefaultShapeMixin`](DefaultShapeMixin.md).[`StickableMixin`](StickableMixin.md).[`AspectRatioLockMixin`](AspectRatioLockMixin.md)
...
Defined in: figmaPluginTypes.ts:9113
...
Defined in: figmaPluginTypes.ts:9117
