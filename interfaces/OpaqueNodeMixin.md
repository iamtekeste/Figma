...
Defined in: figmaPluginTypes.ts:7166
...
- [`BaseNodeMixin`](BaseNodeMixin.md).[`SceneNodeMixin`](SceneNodeMixin.md).[`ExportMixin`](ExportMixin.md).[`DimensionAndPositionMixin`](DimensionAndPositionMixin.md)
