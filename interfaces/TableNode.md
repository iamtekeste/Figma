...
Defined in: figmaPluginTypes.ts:8982
...
- [`OpaqueNodeMixin`](OpaqueNodeMixin.md).[`MinimalFillsMixin`](MinimalFillsMixin.md).[`MinimalBlendMixin`](MinimalBlendMixin.md)
...
Defined in: figmaPluginTypes.ts:9000
...
Defined in: figmaPluginTypes.ts:8995
...
Defined in: figmaPluginTypes.ts:8986
...
> **cellAt**(`rowIndex`, `columnIndex`): [`TableCellNode`](TableCellNode.md)

Defined in: figmaPluginTypes.ts:9008
...
Defined in: figmaPluginTypes.ts:8990
...
Defined in: figmaPluginTypes.ts:9022
...
Defined in: figmaPluginTypes.ts:9015
...
Defined in: figmaPluginTypes.ts:9052
...
Defined in: figmaPluginTypes.ts:9044
...
> **removeColumn**(`columnIndex`): `void`

Defined in: figmaPluginTypes.ts:9036
...
Defined in: figmaPluginTypes.ts:9029
...
> **resizeColumn**(`columnIndex`, `width`): `void`

Defined in: figmaPluginTypes.ts:9066
...
> **resizeRow**(`rowIndex`, `height`): `void`

Defined in: figmaPluginTypes.ts:9059
