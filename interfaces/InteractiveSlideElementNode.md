...
Defined in: figmaPluginTypes.ts:9894
...
> `readonly` **interactiveSlideElementType**: `"EMBED"` \| `"POLL"` \| `"FACEPILE"` \| `"ALIGNMENT"` \| `"YOUTUBE"`

Defined in: figmaPluginTypes.ts:9902
...
Defined in: figmaPluginTypes.ts:9898
...
Defined in: figmaPluginTypes.ts:9906
