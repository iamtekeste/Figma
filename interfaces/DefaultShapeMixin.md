...
Defined in: figmaPluginTypes.ts:7095
...
- [`BaseNodeMixin`](BaseNodeMixin.md).[`SceneNodeMixin`](SceneNodeMixin.md).[`ReactionMixin`](ReactionMixin.md).[`BlendMixin`](BlendMixin.md).[`GeometryMixin`](GeometryMixin.md).[`LayoutMixin`](LayoutMixin.md).[`ExportMixin`](ExportMixin.md)
