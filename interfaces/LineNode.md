...
Defined in: figmaPluginTypes.ts:8536
...
- [`DefaultShapeMixin`](DefaultShapeMixin.md).[`ConstraintMixin`](ConstraintMixin.md).[`AnnotationsMixin`](AnnotationsMixin.md)
...
Defined in: figmaPluginTypes.ts:8540
...
Defined in: figmaPluginTypes.ts:8544
