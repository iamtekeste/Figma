...
Defined in: figmaPluginTypes.ts:9616
...
- [`OpaqueNodeMixin`](OpaqueNodeMixin.md).[`StickableMixin`](StickableMixin.md)
...
Defined in: figmaPluginTypes.ts:9620
...
Defined in: figmaPluginTypes.ts:9626
...
> `readonly` **widgetSyncedState**: `object`

Defined in: figmaPluginTypes.ts:9632
...
Defined in: figmaPluginTypes.ts:9638
...
> **cloneWidget**(`syncedStateOverrides`, `syncedMapOverrides?`): `WidgetNode`

Defined in: figmaPluginTypes.ts:9658
...
> **setWidgetSyncedState**(`syncedState`, `syncedMap?`): `void`

Defined in: figmaPluginTypes.ts:9681
