...
Defined in: figmaPluginTypes.ts:9093
...
- [`DefaultShapeMixin`](DefaultShapeMixin.md).[`ConstraintMixin`](ConstraintMixin.md).[`CornerMixin`](CornerMixin.md).[`VectorLikeMixin`](VectorLikeMixin.md).[`StickableMixin`](StickableMixin.md).[`AspectRatioLockMixin`](AspectRatioLockMixin.md)
...
[`VectorLikeMixin`](VectorLikeMixin.md).[`handleMirroring`](VectorLikeMixin.md#handlemirroring)
...
[`StickableMixin`](StickableMixin.md).[`stuckTo`](StickableMixin.md#stuckto)
...
Defined in: figmaPluginTypes.ts:9103
...
[`VectorLikeMixin`](VectorLikeMixin.md).[`vectorNetwork`](VectorLikeMixin.md#vectornetwork)
...
[`VectorLikeMixin`](VectorLikeMixin.md).[`vectorPaths`](VectorLikeMixin.md#vectorpaths)
...
Defined in: figmaPluginTypes.ts:9107
...
[`VectorLikeMixin`](VectorLikeMixin.md).[`setVectorNetworkAsync`](VectorLikeMixin.md#setvectornetworkasync)
