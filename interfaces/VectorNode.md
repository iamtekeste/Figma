...
Defined in: figmaPluginTypes.ts:8609
...
- [`DefaultShapeMixin`](DefaultShapeMixin.md).[`ConstraintMixin`](ConstraintMixin.md).[`CornerMixin`](CornerMixin.md).[`VectorLikeMixin`](VectorLikeMixin.md).[`AnnotationsMixin`](AnnotationsMixin.md).[`AspectRatioLockMixin`](AspectRatioLockMixin.md)
...
Defined in: figmaPluginTypes.ts:8619
...
Defined in: figmaPluginTypes.ts:8623
