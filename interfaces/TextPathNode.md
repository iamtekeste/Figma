...
Defined in: figmaPluginTypes.ts:8746
...
If the manifest contains`"documentAccess": "dynamic-page"`, this property is read-only. Use [TextPathNode.setTextStyleIdAsync](#settextstyleidasync) to update the style.
...
`NonResizableTextPathMixin.getRangeTextStyleId`
...
`NonResizableTextPathMixin.setRangeBoundVariable`
...
`NonResizableTextPathMixin.setRangeFills`
...
`NonResizableTextPathMixin.setRangeFillStyleId`
...
`NonResizableTextPathMixin.setRangeFillStyleIdAsync`
...
`NonResizableTextPathMixin.setRangeFontName`
...
`NonResizableTextPathMixin.setRangeFontSize`
...
`NonResizableTextPathMixin.setRangeHyperlink`
...
`NonResizableTextPathMixin.setRangeLetterSpacing`
...
`NonResizableTextPathMixin.setRangeTextCase`
...
`NonResizableTextPathMixin.setRangeTextStyleId`
...
`NonResizableTextPathMixin.setRangeTextStyleIdAsync`
...
> **setTextStyleIdAsync**(`styleId`): `Promise`\<`void`\>

Defined in: figmaPluginTypes.ts:8734
